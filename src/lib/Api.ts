...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     */
    usersIdUpdate: (params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/api/users/[id]`,
        method: "PUT",
        ...params,
     ...
     */
    usersIdDelete: (params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/api/users/[id]`,
        method: "DELETE",
        ...params,
     ...
     *
     * @tags Users
     * @name UsersGetUsersList
     * @request GET:/api/users/getUsers
     */
    usersGetUsersList: (params: RequestParams = {}) =>
      this.request<void, any>({
